...
def main():
    ...
    unit_from = st.text_input("Enter the value you want to convert from: (e.g. metres, kilometers, grams, kilograms)")
    unit_to = st.text_input("Enter the value you want to convert: (e.g. metres, kilometers, grams, kilograms)")
